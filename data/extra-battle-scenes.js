(function() {
  ...
  window.EXTRA_BATTLE_SCENES = {
    ...
    "anegawa": {
      ...
      terrain: terrain({
        bumps: [{ x: -220, z: -120, r: 140, amp: 18 }, { x: 210, z: 112, r: 140, amp: 18 }, { x: 160, z: -90, r: 120, amp: 16 }],
        ridges: [{ id: "oda_rear", x: -220, z: -122, rx: 170, rz: 72, amp: 18 }, { id: "asakura_rear", x: 212, z: 112, rx: 160, rz: 78, amp: 18 }],
        basins: [{ x: 0, z: 8, rx: 280, rz: 70, amp: 9 }],
        roads: [
          { width: 7, points: [[-260, -56], [-132, -44], [-20, -24], [108, -36], [250, -58]] },
          { width: 7, points: [[-254, 72], [-130, 62], [-22, 48], [108, 62], [254, 88]] }
        ],
      ...
      places: [
        ...
        { name: "野村", x: -118, z: -54, scale: 8 },
        { name: "三田村", x: -84, z: 70, scale: 8 },
        { name: "小谷方面", x: 196, z: -108, scale: 8, opacity: 0.72 }
      ],
      units: [
        { id: "nobunaga", name: "織田信長", side: "oda", men: "約23,000", note: "姉川北寄りで浅井軍と正面衝突する。", path: [[6, -214, -62], [8.4, -112, -44], [10.2, -24, -28], [13, 34, -34]], size: 66, initialFacing: [1, 0] },
        { id: "ieyasu", name: "徳川家康", side: "tokugawa", men: "約5,000", note: "南寄りで朝倉軍を受け止め、押し返す。", path: [[6, -210, 76], [8.6, -112, 64], [10.4, -20, 52], [13, 52, 60]], size: 40, initialFacing: [1, -0.1] },
        { id: "azai", name: "浅井長政", side: "azai", men: "約8,000", note: "織田軍正面に出る。序盤は押すが、後半に崩れる。", path: [[6, 176, -74], [8.2, 92, -50], [10.4, 8, -30], [12, 74, -66], [13, 156, -98]], fade: [12, 13], size: 48, initialFacing: [-1, 0] },
        { id: "asakura", name: "朝倉景健", side: "asakura", men: "約11,000", note: "徳川軍と南側で激突し、押し返される。", path: [[6, 190, 90], [8.6, 100, 72], [10.2, 14, 56], [12.2, 86, 84], [13, 172, 120]], fade: [12.2, 13], size: 54, initialFacing: [-1, -0.1] },
        { id: "oda_reserve", name: "織田予備隊", side: "oda", men: "約3,000", note: "中央へ押し出し、浅井軍の後退を促す。", path: [[6, -188, 4], [9.4, -96, 2], [11, -18, 2], [13, 76, -12]], size: 32, initialFacing: [1, 0] }
      ],
      arrows: [
        { t0: 7.8, t1: 10.6, from: [-198, -58], to: [20, -30], color: 0xffd35c, head: 20, width: 12 },
        { t0: 8, t1: 10.8, from: [180, 86], to: [10, 54], color: 0x8fd9c9, head: 18, width: 10 },
        { t0: 11.2, t1: 13, from: [20, 54], to: [158, 112], color: 0x8fd9c9, head: 18, width: 10 }
      ],
      timelineEvents: [
      ...
      captions: [
        { t: 6.2, title: "四軍が対峙", body: "姉川を挟み、織田・徳川軍と浅井・朝倉軍が向かい合う。", focus: [0, 4], duration: 0.9 },
        { t: 8.6, title: "渡河", body: "両軍が川筋へ前進し、戦場は姉川沿いへ集中する。", focus: [-16, 16], duration: 0.9 },
        { t: 10.1, title: "開戦", body: "北では織田と浅井、南では徳川と朝倉が激突する。", focus: [4, 18], duration: 0.9 },
        { t: 11.7, title: "押返し", body: "徳川軍と織田予備隊の圧力で、浅井・朝倉軍の線が崩れ始める。", focus: [48, 40], duration: 0.9 },
        { t: 12.4, title: "敗走", body: "浅井・朝倉軍は東へ後退し、織田・徳川軍が戦場を保持する。", focus: [118, 84], duration: 0.9 }
      ],
    ...
    "osaka-summer": {
      ...
      units: [
        ...
        { id: "sanada", name: "真田信繁", side: "toyotomi", men: "約3,500", note: "城外へ出て、徳川本陣へ向けて突撃する。", path: [[8, -158, 20], [10.4, -94, -6], [12.3, -18, -10], [13.3, 84, -18], [16, 122, 32]], fade: [14.2, 16], size: 38, initialFacing: [1, 0] },
        { id: "mori", name: "毛利勝永", side: "toyotomi", men: "約6,000", note: "南側で徳川前線を押し、真田隊の突撃を支える。", path: [[8, -184, -34], [10.8, -102, -22], [12.4, -24, 4], [14, 48, 26], [16, -2, 92]], fade: [14.6, 16], size: 44, initialFacing: [1, 0.1] },
      ...
      captions: [
        ...
        { t: 15.2, title: "落城へ", body: "城外戦に敗れた豊臣方は大坂城へ押し戻され、終局へ向かう。", focus: [-134, 132], duration: 0.88 }
      ],
